...
from custom_components.anova_oven.anova_sdk.client import WebSocketClient
from custom_components.anova_oven.anova_sdk.exceptions import CommandError
...
class TestWebSocketClient:
    ...
    @pytest.mark.asyncio
    @patch('custom_components.anova_oven.anova_sdk.client.websockets.connect')
    @patch('custom_components.anova_oven.anova_sdk.client.settings')
