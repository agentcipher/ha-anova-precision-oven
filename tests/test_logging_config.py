...
from custom_components.anova_oven.anova_sdk.logging_config import TokenMaskingFilter, setup_logging
...
class TestTokenMaskingFilter:
    ...
    def test_filter_with_token_in_message(self):
        ...
        with patch('custom_components.anova_oven.anova_sdk.logging_config.settings') as mock_settings:
...
class TestSetupLogging:
    ...
    @patch('custom_components.anova_oven.anova_sdk.logging_config.settings')
