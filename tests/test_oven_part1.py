...
from custom_components.anova_oven.anova_sdk.exceptions import ConfigurationError, DeviceNotFoundError
...
def mock_logger():
    """Mock logger."""
    with patch('custom_components.anova_oven.anova_sdk.oven.setup_logging') as mock:
